...
/**
The default implementation of the `AppSettingsProvider` protocol.
Uses `NSUserDefaults` under the hood.
*/
@objc public class DefaultAppSettingsProvider: AppSettingsProvider
{
...
/**
The default implementation of the `AppSettingsStorage` protocol.
Uses `NSUserDefaults` under the hood.
*/
@objc public class DefaultAppSettingsStorage: DefaultAppSettingsProvider, AppSettingsStorage
{
    /**
    Initializes a new instance using `NSUserDefaults.standardUserDefaults()`
    as the backing store.
...
/**
An implementation of the `AppSettingsWriter` class that uses
`NSUserDefaults` under the hood.
*/
@objc public class DefaultAppSettings: AppSettingsWriter
{
    /**
    ...
    */
    public init()
    {
        super.init(storage: DefaultAppSettingsStorage())
    }
}
