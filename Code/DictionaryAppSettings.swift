...
/**
An `AppSettingsProvider`implementation that takes its
values from an `NSDictionary` instance passed to the constructor.
*/
public class DictionaryAppSettingsProvider: AppSettingsProvider
{
...
/**
An `AppSettingsStorage` implementation that uses as a backing
store the `NSMutableDictionary` instance passed to the constructor.
*/
public class MutableDictionaryAppSettingsStorage: DictionaryAppSettingsProvider, AppSettingsStorage
{
