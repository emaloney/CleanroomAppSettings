...
**This is the `swift2.3` branch of CleanroomAppSettings.** It uses **Swift 2.3** and **requires Xcode 8.0 beta 6** (or higher) to compile.
...
Want to learn more about CleanroomAppSettings? Check out [the README](https://github.com/emaloney/CleanroomAppSettings/blob/master/README.md).
