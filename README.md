...
Branch|Build status
--------|------------------------
`master`|[![Build status: master branch](https://travis-ci.org/emaloney/CleanroomAppSettings.svg?branch=master)](https://travis-ci.org/emaloney/CleanroomAppSettings)
`swift2.3`|[![Build status: swift2.3 branch](https://travis-ci.org/emaloney/CleanroomAppSettings.svg?branch=swift2.3)](https://travis-ci.org/emaloney/CleanroomAppSettings)
`swift3`|[![Build status: swift3 branch](https://travis-ci.org/emaloney/CleanroomAppSettings.svg?branch=swift3)](https://travis-ci.org/emaloney/CleanroomAppSettings)
